  ...
  return (
    <div className="bg-gray-100 w-[90%] md:w-[80%] lg:w-[50%] p-5 rounded-sm shadow-md">
      ...
      <form
        ...
        {/* TODOS ADD BUTTON */}
        <button className="bg-blue-500 text-white rounded-sm shadow-md w-full my-2 py-2 transition-all duration-100 hover:bg-blue-600">{isLoadingPost ? "Adding ... !!!" : "Add Todo"}</button>
      </form>
    </div>
  );
};
